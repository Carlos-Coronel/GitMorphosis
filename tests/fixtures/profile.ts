...
export const profileFixture: GitHubProfile = {
  ...
  repositories: [
    { name: 'hello-world', description: 'A first repository', language: 'TypeScript', stars: 10, forks: 2, url: 'https://github.com/octocat/hello-world', isForked: false, updatedAt: '2026-01-01T00:00:00Z', topics: ['demo'] },
    { name: 'tools', description: 'Useful tools', language: 'JavaScript', stars: 5, forks: 1, url: 'https://github.com/octocat/tools', isForked: false, updatedAt: '2026-01-02T00:00:00Z', topics: [] },
  ],
  topLanguages: [{ language: 'TypeScript', percentage: 60, color: '#3178c6' }, { language: 'JavaScript', percentage: 40, color: '#f1e05a' }],
  pinnedRepos: [], projectAnalyses: [],
